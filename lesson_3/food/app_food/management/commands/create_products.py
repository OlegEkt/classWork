...
# from app_food.management.commands.models import Product
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        for product in products:
            ...
            new_product.save()
            self.stdout.write(f'Продукт {product} создан.')
        self.stdout.write(self.style.SUCCESS(f'Продукты созданы'))
