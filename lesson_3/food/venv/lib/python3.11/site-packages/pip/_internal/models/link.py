...
class Link(KeyBasedCompareMixin):
    ...
    def filename(self) -> str:
        ...
        if not name:
            # Make sure we don't leak lesson_4_aut information if the netloc
    ...
    def netloc(self) -> str:
        """
        This can contain lesson_4_aut information.
        """
...
class _CleanResult(NamedTuple):
    ...
    1. Drop the basic lesson_4_aut part. This is technically wrong since a server can
       serve different content based on lesson_4_aut, but if it does that, it is even
       impossible to guarantee two URLs without lesson_4_aut are equivalent, since
       the user can input different lesson_4_aut information when prompted. So the
       practical solution is to assume the lesson_4_aut doesn't affect the response.
